...
export const PRODUCTS: Product[] = [
  // ─── 1. Tarkir: Dragonstorm — Play Booster Box ───────────────────────────
  {
    ...
    priceChangePct: 2.59,
    priceHistory: makeHistory(149.99, 'flat'),
  ...
  // ─── 2. Tarkir: Dragonstorm — Collector Booster Box ──────────────────────
  {
    ...
    priceChangePct: -1.40,
    priceHistory: makeHistory(289.99, 'flat'),
  ...
  // ─── 3. Secret Lair × Global Fund for Women ──────────────────────────────
  {
    ...
    priceChangePct: 2.88,
    priceHistory: makeHistory(74.99, 'flat'),
    investmentScore: 71,
    recommendation: 'BUY',
    recommendationRationale:
  ...
  // ─── 4. Final Fantasy Play Booster Box ───────────────────────────────────
  {
    ...
    priceChangePct: 7.46,
    priceHistory: makeHistory(179.99, 'flat'),
  ...
  // ─── 5. Final Fantasy Collector Booster Box ───────────────────────────────
  {
    ...
    priceChangePct: 5.49,
    priceHistory: makeHistory(349.99, 'flat'),
  ...
  // ─── 7. Secret Lair × Fallout ─────────────────────────────────────────────
  {
    ...
    priceChangePct: 6.26,
    priceHistory: makeHistory(89.99, 'flat'),
    investmentScore: 76,
    recommendation: 'BUY',
    recommendationRationale:
